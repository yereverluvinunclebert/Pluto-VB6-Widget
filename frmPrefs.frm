   ...
   Begin VB.Frame fraPosition 
      ...
      Begin VB.Frame fraPositionInner 
         ...
         Begin VB.ComboBox cmbWidgetLandscape 
            Height          =   315
            ItemData        =   "frmPrefs.frx":26FA
            Left            =   2250
            List            =   "frmPrefs.frx":26FC
            Style           =   2  'Dropdown List
            TabIndex        =   75
         ...
         End
         Begin VB.Label lblPosition 
            Caption         =   $"frmPrefs.frx":297B
            Height          =   3045
            Index           =   6
            Left            =   2265
            TabIndex        =   68
            Tag             =   "lblAlarmSoundDesc"
            ToolTipText     =   $"frmPrefs.frx":2B17
            Top             =   450
            Width           =   5175
         End
         Begin VB.Label lblPosition 
   ...
   Begin VB.Frame fraDevelopment 
      ...
      Begin VB.Frame fraDevelopmentInner 
         ...
         Begin VB.ComboBox cmbDebug 
            Height          =   315
            ItemData        =   "frmPrefs.frx":2E85
            Left            =   1530
            List            =   "frmPrefs.frx":2E87
            Style           =   2  'Dropdown List
            TabIndex        =   56
   ...
   Begin VB.Frame fraConfig 
      ...
      Begin VB.Frame fraConfigInner 
         ...
         Begin VB.ComboBox cmbScrollWheelDirection 
            Height          =   315
            ItemData        =   "frmPrefs.frx":8A87
            Left            =   1995
            List            =   "frmPrefs.frx":8A89
            Style           =   2  'Dropdown List
            TabIndex        =   90
